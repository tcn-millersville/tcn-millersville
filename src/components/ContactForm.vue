        ...
        <div class="col">
          ...
          <form method="post" action="https://forms.un-static.com/forms/2e4d27f2d07251e28cdf672f0caefe75aa0eee9e">
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="inputName" id="inputName" placeholder="Please enter your name">
              </div>
            </div>
            <div class="form-group row">
...
/* added to create visual seperation between inputs in the contact form. */
.form-group.row {
  margin-top: 10px;
}
